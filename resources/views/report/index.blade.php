...
@section('content')
    <div class="container mx-auto mt-10 grid grid-cols-1 md:grid-cols-2 gap-6">
        <!-- Card รายงานระดับน้ำ -->
        <div class="card transition-transform transform hover:-translate-y-2 duration-300 max-w-xs mx-auto">
            <a href="{{ route('water-reports.index') }}"
                ...
                <div class="flex flex-col justify-center items-center h-full">
                    <!-- ไอคอนน้ำ -->
                    <i class="fas fa-water text-5xl mb-4"></i>
                    <h3 class="text-lg font-semibold text-center">รายงานระดับน้ำ</h3>
                    <p class="text-sm mt-2 text-center">ดูรายงานระดับน้ำในพื้นที่และติดตามสถานการณ์น้ำท่วม</p>
                </div>
            </a>
        </div>
        ...
        <div class="card transition-transform transform hover:-translate-y-2 duration-300 max-w-xs mx-auto">
            <a href="{{ route('request.index') }}"
                ...
                <div class="flex flex-col justify-center items-center h-full">
                    ...
                    <h3 class="text-lg font-semibold text-center">รายการขอความช่วยเหลือ</h3>
                    <p class="text-sm mt-2 text-center">ตรวจสอบและจัดการคำขอความช่วยเหลือในพื้นที่ของคุณ</p>
                </div>
            </a>
        </div>
    </div>
